...
public class TaskDialogScreen extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jPanelToolBarLayout.setHorizontalGroup(
            ...
            .addGroup(jPanelToolBarLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jLabelToolBarTitle, javax.swing.GroupLayout.PREFERRED_SIZE, 255, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jLabelToolBarSaveMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabelToolBarSaveMouseClicked
        ...
        try {
            if(!isFieldsValid()){
                hideErrorFields();
               // JOptionPane.showMessageDialog(rootPane, "A tarefa não foi salva pois existe campos não preenchidos");
    ...
    // End of variables declaration//GEN-END:variables
       ...
       //Setando o projeto pois a tarefa pertence a um projeto passo 1
